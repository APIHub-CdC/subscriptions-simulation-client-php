...
namespace SubscripcionSimulacionClientPhp\Client\Interceptor;
...
use \SubscripcionSimulacionClientPhp\Client\Interceptor\KeyHandler;
use \SubscripcionSimulacionClientPhp\Client\Interceptor\MyLogger;
use \SubscripcionSimulacionClientPhp\Client\Model\Errors;
use \SubscripcionSimulacionClientPhp\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\SubscripcionSimulacionClientPhp\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \SubscripcionSimulacionClientPhp\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \SubscripcionSimulacionClientPhp\Client\Model\Errores(["errors" => [$error]]);
